    ...
    public void testVersionFromString() throws Exception {
        ...
        for (int i = 0; i < cases.size(); i++) {
            ...
            for (int j = 0; j < i; j++) {
                ...
                assertTrue(currentVersion.isLaterVersionThan(olderVersion));
                assertFalse(currentVersion.isSameVersionAs(olderVersion));
                assertFalse(currentVersion.isEarlierVersionThan(olderVersion));

                assertFalse(olderVersion.isLaterVersionThan(currentVersion));
                assertFalse(olderVersion.isSameVersionAs(currentVersion));
                assertTrue(olderVersion.isEarlierVersionThan(currentVersion));
            }
        }
